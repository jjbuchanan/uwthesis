...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{
      Fits to the mass distributions for $\Pe\Pe$ (left) and $\Pe\gamma$ (right) selections, for probe \pT\ between 175 and 190\unit{GeV} (upper) and
      between 190 and 220\unit{GeV} (lower). The blue dashed curve is the background template, and the red solid curve is the sum of the signal and background templates.
    }
    \label{fig:efake_fits_a}
  \end{center}
\end{figure}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{
      Fits to the mass distributions for $\Pe\Pe$ (left) and $\Pe\gamma$ (right) selections, for probe \pT\ between 220 and 270\unit{GeV} (upper) and
      above 270\unit{GeV} (lower). The blue dashed curve is the background template, and the red solid curve is the sum of the signal and background templates.
    }
    \label{fig:efake_fits_b}
  \end{center}
\end{figure}
